...
프로그래머스 팀에서는 기능 개선 작업을 수행 중입니다.
 기능은 진도가 100%일 때 서비스에 반영할 수 있습니다.
...
*/
    ...
    // 문제 5일째인데 뒤에 1 다음 5면 나와야지 O

    public static void main(String[] args) {

        int[] progresses1 = {54, 30, 55};
        int[] speeds1 = {1, 30, 5};
        int[] progresses2 = {95, 90, 99, 99, 80, 99};
        int[] speeds2 = {1, 1, 1, 1, 1, 1};
        System.out.println("#### return1 " + Arrays.toString(solution(progresses1, speeds1)));
        System.out.println("#### return2 " + Arrays.toString(solution(progresses2, speeds2)));
    }
}
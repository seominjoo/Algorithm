...
*/
        ...
        for (int truck_weight : truck_weights) {
            while (true) {
                if (queue.isEmpty()) { // 비어있을 때
                    ...
                    answer++;
                    break;
                } else if (queue.size() < bridge_length) { // 자리 있음
    ...
    public static void main(String[] args) {
        ...
        System.out.println("#### return1 " + solution(bridge_length1, weight1, truck_weights1));
        System.out.println("#### return2 " + solution(bridge_length2, weight2, truck_weights2));
        System.out.println("#### return3 " + solution(bridge_length3, weight3, truck_weights3));
    }
}